...
from immunity_controller.config.tests.test_admin import TestAdmin as TestConfigAdmin
...
class TestAdmin(BaseTestAdmin, TestCase):
    ...
    def test_admin_menu_groups(self):
        # Test menu group (immunity-utils menu group) for Build, Category,
    ...
    @capture_stderr()
    @mock.patch(
        'immunity_firmware_upgrader.utils.get_upgrader_class_from_device_connection'
    )
...
_mock_updrade = 'immunity_firmware_upgrader.upgraders.openwrt.OpenWrt.upgrade'
_mock_connect = 'immunity_controller.connection.models.DeviceConnection.connect'
