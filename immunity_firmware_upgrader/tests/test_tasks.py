...
class TestTasks(TestUpgraderMixin, TransactionTestCase):
    _mock_upgrade = 'immunity_firmware_upgrader.upgraders.openwrt.OpenWrt.upgrade'
    ...
    @mock.patch(
        'immunity_firmware_upgrader.base.models.AbstractUpgradeOperation.upgrade',
    ...
    @mock.patch(_mock_connect, return_value=True)
    @mock.patch(
        'immunity_firmware_upgrader.base.models.AbstractDeviceFirmware.create_upgrade_operation',
        side_effect=SoftTimeLimitExceeded(),
    )
    @capture_any_output()
