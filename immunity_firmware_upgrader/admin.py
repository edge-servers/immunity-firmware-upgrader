...
from immunity_users.multitenancy import MultitenantAdminMixin, MultitenantOrgFilter
from immunity_utils.admin import ReadOnlyAdmin, TimeReadonlyAdminMixin
...
class DeviceFirmwareInline(MultitenantAdminMixin, admin.StackedInline):
    ...
    # hack for immunity-monitoring integartion
